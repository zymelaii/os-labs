...
ASMCALL void lcr0(u32 val) { asm volatile("movl %0, %%cr0" : : "r"(val)); }
...
ASMCALL void lcr3(u32 val) { asm volatile("movl %0, %%cr3" : : "r"(val)); }
...
ASMCALL void lcr4(u32 val) { asm volatile("movl %0, %%cr4" : : "r"(val)); }
...
ASMCALL void clear_dir_flag() { asm volatile("cld"); }

ASMCALL void disable_int() { asm volatile("cli"); }

ASMCALL void enable_int() { asm volatile("sti"); }

ASMCALL void halt() { asm volatile("hlt"); }

ASMCALL void barrier() { asm volatile("mfence" ::: "memory"); }
